...
import views.html.{AnswerErrorTemplate, ErrorTemplate}
...
class ErrorHandler @Inject()(
  ...
  override def standardErrorTemplate(pageTitle: String, heading: String, message: String)(implicit rh: RequestHeader): Future[Html] =
    Future.successful(view(pageTitle, heading, message)(rh, messagesApi.preferred(rh), appConfig))
}
