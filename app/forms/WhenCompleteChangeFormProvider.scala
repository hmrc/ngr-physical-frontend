...
class WhenCompleteChangeFormProvider @Inject() extends Mappings {

  def apply()(implicit messages: Messages): Form[LocalDate] =
    Form(
      "value" -> localDate(
        invalidKey     = "whenCompleteChange.error.invalid",
        allRequiredKey = "whenCompleteChange.error.required.all",
