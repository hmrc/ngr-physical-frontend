  ...
  "Navigator" - {
    ...
    "in Normal mode" - {
      ...
      "must go to HaveYouChangedSpacePage from WhenCompleteChangePage" in {
        ...
        navigator.nextPage(WhenCompleteChangePage, NormalMode, userAnswers, assessmentId) mustBe routes.HaveYouChangedController.loadSpace(NormalMode, assessmentId)
      }
      ...
      "must go to HaveYouChangedInternalPage from HaveYouChangedSpacePage when 'No' is selected as an option" in {
        ...
        navigator.nextPage(HaveYouChangedSpacePage, NormalMode, userAnswers, assessmentId) mustBe routes.HaveYouChangedController.loadInternal(NormalMode, assessmentId)
      }
      ...
      "must go to ChangeToUseOfSpacePage from HaveYouChangedSpacePage when 'Yes' is selected as an option" in {
        ...
        navigator.nextPage(HaveYouChangedSpacePage, NormalMode, userAnswers, assessmentId) mustBe routes.ChangeToUseOfSpaceController.onPageLoad(NormalMode, assessmentId)
      }

      "must go to HaveYouChangedInternalPage from ChangeToUseOfSpacePage" in {
        val userAnswers = UserAnswers("id")
        navigator.nextPage(ChangeToUseOfSpacePage, NormalMode, userAnswers, assessmentId) mustBe routes.HaveYouChangedController.loadInternal(NormalMode, assessmentId)
      }
      ...
      "must go to HaveYouChangedInternalPage from HaveYouChangedInternalPage when 'No' is selected as an option" in {
        ...
        navigator.nextPage(HaveYouChangedInternalPage, NormalMode, userAnswers, assessmentId) mustBe routes.HaveYouChangedController.loadExternal(NormalMode, assessmentId)
      }
      ...
      "must go to WhichInternalFeaturePage from HaveYouChangedInternalPage when 'Yes' is selected as an option" in {
        ...
        navigator.nextPage(HaveYouChangedInternalPage, NormalMode, userAnswers, assessmentId) mustBe routes.WhichInternalFeatureController.onPageLoad(NormalMode, assessmentId)
      }
      ...
      "must go to HaveYouChangedExternalPage from HaveYouChangedExternalPage when 'No' is selected as an option" in {
        ...
        navigator.nextPage(HaveYouChangedExternalPage, NormalMode, userAnswers, assessmentId) mustBe routes.AnythingElseController.onPageLoad(NormalMode, assessmentId)
      }
      ...
      "must go from a HaveYouChangedExternalPage to CheckYourAnswersPage when 'No' is selected as an option" in {
        ...
        navigator.nextPage(HaveYouChangedExternalPage, CheckMode, userAnswers, assessmentId) mustBe routes.CheckYourAnswersController.onPageLoad(assessmentId)
      }
      ...
      "must go to WhichExternalFeaturePage from HaveYouChangedExternalPage when 'Yes' is selected as an option" in {
        ...
        navigator.nextPage(HaveYouChangedExternalPage, NormalMode, userAnswers, assessmentId) mustBe routes.WhichExternalFeatureController.onPageLoad(NormalMode, assessmentId)
      }
      ...
      "must go to not told us about any changes page when all have you changed pages are set to no" in {
        val userAnswers = UserAnswers("id").set(HaveYouChangedSpacePage, false).success.value
          .set(HaveYouChangedInternalPage, false).success.value
          .set(HaveYouChangedExternalPage, false).success.value
        navigator.nextPage(HaveYouChangedExternalPage, NormalMode, userAnswers, assessmentId) mustBe routes.NotToldAnyChangesController.show(assessmentId)
      }

      "must go SupportingDocuments from AnythingElsePage" in {
        val userAnswers = UserAnswers("id")
        navigator.nextPage(AnythingElsePage, NormalMode, userAnswers, assessmentId) mustBe routes.SupportingDocumentsController.onPageLoad(assessmentId)
      }
    ...
    "in Check mode" - {
      ...
      "must go from a HaveYouChangedSpacePage` to ChangeToUseOfSpacePage when 'Yes' is selected an an option" in {
        ...
        navigator.nextPage(HaveYouChangedSpacePage, CheckMode, userAnswers, assessmentId) mustBe routes.ChangeToUseOfSpaceController.onPageLoad(CheckMode, assessmentId)
      }

      "must go from a HaveYouChangedSpacePage` to CheckYourAnswersPage when 'No' is selected an an option" in {
        val userAnswers = UserAnswers("id").set(HaveYouChangedSpacePage, false).success.value
        navigator.nextPage(HaveYouChangedSpacePage, CheckMode, userAnswers, assessmentId) mustBe routes.CheckYourAnswersController.onPageLoad(assessmentId)
      }
      ...
      "must go from a HaveYouChangedInternalPage` to WhichInternalFeaturePage when 'Yes' is selected an an option" in {
        ...
        navigator.nextPage(HaveYouChangedInternalPage, CheckMode, userAnswers, assessmentId) mustBe routes.WhichInternalFeatureController.onPageLoad(CheckMode, assessmentId)
      }
      ...
      "must go from a HaveYouChangedInternalPage` to WhichInternalFeaturePage when 'No' is selected an an option" in {
        ...
        navigator.nextPage(HaveYouChangedInternalPage, CheckMode, userAnswers, assessmentId) mustBe routes.HaveYouChangedController.loadExternal(CheckMode, assessmentId)
      }
      ...
      "should throw RuntimeException when no selection is made" in {
        ...
        val ex = intercept[RuntimeException] {
          navigator.nextPage(HaveYouChangedInternalPage, CheckMode, userAnswers, assessmentId)
        }
      ...
      "must go from a HowMuchOfPropertyAirConPage` to SmallCheckYourAnswers when 'AllOf' is selected an an option" in {
        ...
        navigator.nextPage(HowMuchOfPropertyAirConPage, CheckMode, userAnswers, assessmentId) mustBe routes.SmallCheckYourAnswersController.onPageLoad(CYAInternal, CheckMode, assessmentId)
      }
      ...
      "must go from a HaveYouChangedExternalPage` to WhichExternalFeaturePage when 'Yes' is selected an an option" in {
        ...
        navigator.nextPage(HaveYouChangedExternalPage, CheckMode, userAnswers, assessmentId) mustBe routes.WhichExternalFeatureController.onPageLoad(CheckMode, assessmentId)
      }
      ...
      "must go from a WhatHappenedToSolarPanelsPage` to SmallCheckYourAnswers when 'added' is selected an an option" in {
        ...
        navigator.nextPage(WhatHappenedToSolarPanelsPage, CheckMode, userAnswers, assessmentId) mustBe routes.SmallCheckYourAnswersController.onPageLoad(CYAExternal, CheckMode, assessmentId)
      }
