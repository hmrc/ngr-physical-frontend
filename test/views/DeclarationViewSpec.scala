...
class DeclarationViewSpec extends ViewBaseSpec {
  ...
  "Declaration view" must {
    ...
    "show correct " in {
      elementText(Selectors.firstParagraph) mustBe "By submitting these details, you declare that to the best of your knowledge the information given is correct and complete."
    }
